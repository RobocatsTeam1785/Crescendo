...
public class DriveSubsystem extends SubsystemBase {
  ...
  StructArrayPublisher<SwerveModuleState> publisher2 = moduleStats
      .getStructArrayTopic("SetStates", SwerveModuleState.struct).publish();
  ...
  public DriveSubsystem() {
    ...
    AutoBuilder.configureHolonomic(
        ...
        new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in your Constants class
            ...
            new PIDConstants(DriveConstants.HEADING_KP, DriveConstants.HEADING_KI, DriveConstants.HEADING_KD), // Rotation
                                                                                                               // PID
                                                                                                               // constants
  ...
  public void drive(double leftX, double leftY, double rightX, double rightY, double leftTrigger, double rightTrigger,
      int FOV, boolean fieldRelative, double periodSeconds) {
    double xSpeed = -m_xspeedLimiter.calculate(MathUtil.applyDeadband(leftY, 0.075))
        * speedMod * DriveConstants.TRANSLATIONAL_MAX_SPEED;
    double ySpeed = -m_yspeedLimiter.calculate(MathUtil.applyDeadband(leftX, 0.075))
        * speedMod * DriveConstants.TRANSLATIONAL_MAX_SPEED;
    double rot = m_rotLimiter.calculate(MathUtil.applyDeadband(rightX, 0.075))
