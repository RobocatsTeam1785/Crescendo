...
public class FourtyFiveCommand extends Command {
  private ShooterRotSubsystem shooterRotSubsystem;
  /** Creates a new FourtyFiveCommand. */
  public FourtyFiveCommand(ShooterRotSubsystem shooterRot) {
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(shooterRot);
