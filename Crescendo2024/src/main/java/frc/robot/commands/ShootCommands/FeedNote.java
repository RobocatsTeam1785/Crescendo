...
public class FeedNote extends Command {
  ...
  private final double FEED_RPM = 3500;
  private final double FEED_ANGLE = (40-90) * Math.PI / 180;
  ...
  public FeedNote(ShooterSubsystem shooter, ShooterFeederSubsystem shooterFeeder, LEDSubsystem led, ShooterRotSubsystem shooterRot) {
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(shooter, shooterFeeder, led, shooterRot);
    ledSubsystem = led;
  ...
  public void initialize() {
    if(!shooterFeederSubsystem.getPhotoSensor()){
      ...
      RPM = FEED_RPM;
      shooterRotSubsystem.setGoal(FEED_ANGLE);
    }
  }
